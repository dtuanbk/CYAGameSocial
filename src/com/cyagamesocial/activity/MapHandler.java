...
//		}
	...
	public void loadMap_Iso(){
		String location = this.parent.TMXAssetsLocation + this.parent.TMXFileMap + this.parent.TMXFileTag;
		...
		try{
			...
			this.mConvertPixelToScene = new ConvertIsometricPixelToScene(this.map);
			this.setDrawingMethod(TMXIsometricConstants.DRAW_METHOD_ISOMETRIC_CULLING_TILED_SOURCE);
